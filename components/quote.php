...
require './PHPMailer/src/SMTP.php';
 ...
 try {
    ...
    $mail->SMTPSecure = 'ssl';
    $mail->isHTML(true);
    $mail->setFrom($email, 'Request a quotee from '.$firstname);
    $mail->addAddress($email);
    $mail->Subject = 'In Out | Request Quote';
    for ($i=0; $i < count($_FILES['drawing']['tmp_name']); $i++){
        $mail->addAttachment($_FILES['drawing']['tmp_name'][$i], $_FILES['drawing']['name'][$i]);
    }
    ...
    <body style=\"background-color: #e9ecef;\">
      ...
      <div class=\"preheader\" style=\"display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;\">
        Request a quote from a client view the details inside the mail.
      </div>
      <!-- end preheader -->
            ...
            <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"max-width: 600px;\">
              <tr>
                <td align=\"left\" bgcolor=\"#ffffff\" style=\"padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;\">
                  <h1 style=\"text-align:center; margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;\">REQUEST A QUOTE</h1>
                </td>
              </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
            ...
            <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"max-width: 600px;\">
              ...
              <tr>
                <td align=\"left\" bgcolor=\"#ffffff\" style=\"padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;\">
                  ...
                  <p style=\"margin: 0;\"><b>Project:</b> $project</p>
                  <p style=\"margin: 0;\"><b>Website:</b> $web</p> 
                  <p style=\"margin: 0;\"><b>Product:</b> $product</p> 
                  <p style=\"margin: 0;\"><b>Color & Texture:</b> $color_texture</p> 
                  <p style=\"margin: 0;\"><b>Application:</b> $application</p> 
                  <p style=\"margin: 0;\"><b>Installation:</b> $installation</p> 
                  <p style=\"margin: 0;\"><b>Quantity:</b> $quantity</p> 
                  <p style=\"margin: 0;\"><b>Installation Date:</b> $month / $day / $year</p> 
                  <p style=\"margin: 0;\"><b>Address:</b> $address</p> 
                  <p style=\"margin: 0;\"><b>Address Line 2:</b> $address_2</p> 
                  <p style=\"margin: 0;\"><b>City:</b> $city</p> 
                  <p style=\"margin: 0;\"><b>Region:</b> $region</p> 
                  <p style=\"margin: 0;\"><b>Zip:</b> $zip</p> 
                </td>
              </tr>
              <!-- end copy -->
